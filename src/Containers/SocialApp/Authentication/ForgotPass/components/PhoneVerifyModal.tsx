...
export const PhoneModifyModal = React.forwardRef(({ confirm }: Props, ref) => {
      ...
      <Modal transparent={true} visible={_isShowModal}>
        <View style={styles.container}>
          ...
          <View style={styles.modalContainer}>
            ...
            {/* </View> */}
            <NormalText text={translate('PhoneVerify')} style={styles.title} />
            <NormalTextInput
              inputProps={{
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: 'rgba(78,89,111,.9)',
  },
  title: {
    fontSize: moderateScale(17),
